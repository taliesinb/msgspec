# Generated by scripts/gen_js_runtime.py from javascript/src/msgpack.mjs
# Do not edit by hand - edit the .mjs and re-run the generator.
RUNTIME = r"""
...
class Writer {
  ...
  array(arr: any, dtype: string | null) {
...
function decSet(r: Reader, fn: (r: Reader) => any) {
  const n = r.arrayHeader();
  const s = new Set();
...
const _ARRCTOR = new Map<any, string>([
